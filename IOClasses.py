...
# Kris Czaja, 2021-Dec-12, Completed tasks
#------------------------------------------#
...
class FileIO:
    ...
    def save_inventory(file_name: list, lst_Inventory: list) -> None:
        ...
        # Completed modify method to accept a list of file names.
        ...
        # Completed add code to save track data to file           
            with open(file_name_tracks, 'w') as file:
                for disc in lst_Inventory:
                    tracks = disc.cd_tracks
                    disc_id = disc.cd_id
                    for entry in tracks:
                        record = '{},{}'.format(disc_id, entry.get_record())
                        file.write(record)
    ...
    def load_inventory(file_name: list) -> list:
        ...
        try:
            ...
            # Completed add code to load track data
