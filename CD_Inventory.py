...
# Kris Czaja, 2021-Dec-12, Completed task. Commentary to all scripts: I tried to complete tasks on my own
# as much as possible and I did not copy/paste anything from the module, but I relied on sample solution heavily.
#------------------------------------------#
...
while True:
    ...
    if strChoice == 'l':
        ...
        # Completed add code to handle tracks on an individual CD
        ...
        while True:
            ...
            if strChoice == 'a':
                ...
                print ('Tracks on CD are: \n')
                IO.ScreenIO.show_tracks(cd)
            elif strChoice == 'r':
                deletion = input('What is the Track ID you wish to delete? ')
                cd.rmv_track(deletion)
            elif strChoice == 'x':
                break
        else:
